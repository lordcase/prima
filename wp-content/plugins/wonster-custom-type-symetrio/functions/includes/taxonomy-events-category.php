						...
						<?php if ( have_posts() ) : ?>
							<ul class="wtrSearchResultsList">
								<?php while ( have_posts() ) : the_post(); ?>
									...
									<?php $time_start	= get_post_meta( get_the_id(), '_wtr_event_time_start', true ); var_dump($time_start);?>
									<?php $date			= date_i18n( $post_settings['wtr_EventDateFormat']['all'], $time_start ); ?>
